...
/// One running Codex session, as observed by the runtime. Minimal
/// projection of the binary-crate `CodexSession`; only fields the TUI
/// renders.
...
pub trait SessionSource: Send + Sync {
    /// Snapshot of every running Codex session. Order is the
...
pub struct PendingSuggestion {
    ...
    /// shape into the contract (it's already in `codexctl-core::rules` but
...
// ============================================================================
// MockRuntime — for tests in this crate and in codexctl-tui
// ============================================================================

...
/// Records a single Codex session as a highlight reel.
...
impl SessionRecorder {
    pub fn new(
        ...
        let cast_path = if is_gif {
            ...
            tmp.push(format!("codexctl-sess-{}.cast", std::process::id()));
            tmp
        } else {
            final_path.clone()
        };
        ...
        let header = serde_json::json!({
            ...
            "timestamp": std::time::SystemTime::now()
                ...
                .unwrap_or_default()
                .as_secs(),
            "title": format!("codexctl: {session_name}"),
            "env": {
    ...
    fn write_title_card(&mut self) -> std::io::Result<()> {
        ...
        // Compact title card matching Codex's style
        let card = format!(
            "\x1b[2J\x1b[H\r\n\
             \x1b[1;37m  ╭─ {name} ─────────────────────────────╮\x1b[0m\r\n\
             \x1b[1;37m  │                                       │\x1b[0m\r\n\
             \x1b[1;37m  │\x1b[0m  \x1b[36mSession recording\x1b[0m\x1b[1;37m                │\x1b[0m\r\n\
             \x1b[1;37m  │\x1b[0m  \x1b[90mRecorded with codexctl\x1b[0m\x1b[1;37m          │\x1b[0m\r\n\
             \x1b[1;37m  │                                       │\x1b[0m\r\n\
             \x1b[1;37m  ╰───────────────────────────────────────╯\x1b[0m\r\n\r\n"
        );
    ...
    fn emit_highlight(&mut self, event: &SessionEvent) -> std::io::Result<bool> {
        match event {
            SessionEvent::AssistantText(text) => {
                ...
                // Codex-style bullet point with text
            ...
            SessionEvent::ToolUse {
                ...
                // Codex-style rendering per tool type
                match tool.as_str() {
    ...
    pub fn finish(&mut self) -> std::io::Result<()> {
        ...
        let summary = format!(
            "\r\n\r\n\
             ...
             \x1b[1;37m  │                                       │\x1b[0m\r\n\
             \x1b[1;37m  │\x1b[0m  \x1b[90mcodexctl\x1b[0m\x1b[1;37m                            │\x1b[0m\r\n\
             \x1b[1;37m  ╰───────────────────────────────────────╯\x1b[0m\r\n",
